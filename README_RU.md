...
| `/add_student`            | Добавить нового ученика (имя, возраст, класс, город) и получить прогноз погоды по городу ученика. |
...
handlers/
  ...
  students.py          # /add_student — добавление ученика, прогноз погоды по городу
utils/
...
/add_student
# Бот поочерёдно спросит имя, возраст, класс, город и сразу покажет погоду по городу ученика.
```
...
- В БД теперь сохраняется информация об ученике: имя, возраст, класс, город.
- После добавления ученика бот автоматически отправляет прогноз погоды по введённому городу.
